...
const Hero = ( props ) => {
    ...
    return(
        <section className="relative mt-32 md:mt-28 py-10 md:pt-32 md:pb-48 h-full w-full bg-bottom bg-cover overflow-hidden bg-no-repeat" style={{ backgroundImage: `url(${CDN + PROJECT + "/" + data.cover + "?quality=80"})` }}>
            <Container>
